...
uint8_t receiverAddress2[] = { 0xC8, 0xC9, 0xA3, 0x5D, 0x92, 0x48 };  //  ECU 2
...
int counterExercise = 0;  //Counter
int stopExercise = 5;
dataPacket packet = { 1, 0, 0 };  //Package of data to be sent
